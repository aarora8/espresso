...
@dataclass
class TripletLossCriterionConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")


@register_criterion("triplet_loss", dataclass=TripletLossCriterionConfig)
class TripletLossCriterion(FairseqCriterion):
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        # positive = cos(net_output[0], net_output[1])
        # negative = cos(net_output[0], net_output[2])
